...
## Overview
Payment Service handles secure payment processing through Stripe API. It uses Stripe webhooks for asynchronous payment confirmation in the Cinema Booking System.
